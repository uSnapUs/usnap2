...
namespace iPhone_FrontEnd
{
	public class LandingPageView:UIView
	{
		...
		public EventHandler<EventArgs> FindButtonPressed;

		public EventHandler<EventArgs> CreateButtonPressed;

		public EventHandler<EventArgs> MyEventsButtonPressed;
		...
		public override void LayoutSubviews ()
		{
			...
			this._mapView.Frame = this.Bounds;
			//landscape
